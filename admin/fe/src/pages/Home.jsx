...
export default function FilterConfession() {
  ...
  const shoolSentiment = async () => {
    ...
    setError("");
    try {
      const response = await axios.post(`${API_URL}/sentiment`, { data: data});
  ...
  useEffect(() => {
    if (data.length > 0) {
      console.log("Data updated, fetching analyses...", data);
      shoolOverview();
      shoolSentiment();
      schoolTopic();
        ...
        <>
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="flex flex-col rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-300">
                ...
                {isLoadingSentiment ? (
                  ...
                  sentimentContent && sentimentContent.neutral && sentimentContent.neutral.length > 0 ? (
          ...
          <div className="min-h-screen bg-gray-50 p-4">
            ...
            {sentimentContent && !isLoadingSentiment && (
              <EmotionStats data={sentimentContent} startDate={startDate} endDate={endDate} selectedTopic={selectedTopic} />
            )}
          </div>
        </>
      ) : (
